...
#    Updated: 2019/01/07 10:21:43 by gkessler         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

MAIN = main.c
SRCS =  asix_transform.c draw_line.c ft_atoi_base.c ft_create_window.c get_color.c iso_transform.c main.c on_button_click.c on_mouse_move.c put_matrix.c read_file.c
